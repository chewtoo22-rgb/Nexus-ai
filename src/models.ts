export const MODELS = {
  chat: {
    ...
    coding: "@cf/zai-org/glm-5.3",
    multimodal: "@cf/zai-org/glm-5.3-flash",
  ...
  vision: { primary: "@cf/qwen/qwen3.8-27b", fast: "@cf/zai-org/glm-5.3-flash", mistral: "@cf/mistralai/mistral-small-3.1-24b-instruct" },
...
export const AGENT_MODELS = {
  nexus: { primary: MODELS.chat.reasoning, fallback: MODELS.chat.flagship, fast: MODELS.chat.fast },
  builder: { primary: MODELS.chat.coding, fallback: MODELS.chat.flagship, fast: MODELS.chat.multimodal },
  researcher: { primary: MODELS.chat.reasoning, fallback: MODELS.chat.flagship, fast: MODELS.chat.fast },
  creative: { primary: MODELS.chat.multimodal, fallback: MODELS.chat.vision, fast: MODELS.chat.fast },
  analyst: { primary: MODELS.chat.reasoning, fallback: MODELS.chat.multimodal, fast: MODELS.chat.fast },
} as const;
